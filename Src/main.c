...
/* USER CODE BEGIN PM */
/**************属性上报消息构造**************/
char Tx_str[BUFFE_SIZE] = "AT+HMPUB=1,\"$oc/devices/649a72522a3b1d3de71e9e81_car02/sys/properties/report\",87,\"{\\\"services\\\":[{\\\"service_id\\\":\\\"car_01\\\",\\\"properties\\\":{\\\"location\\\":[";
char Tx_FlagSet[BUFFE_SIZE] = "AT+HMPUB=1,\"$oc/devices/649a72522a3b1d3de71e9e81_car02/sys/properties/report\",66,\"{\\\"services\\\":[{\\\"service_id\\\":\\\"car_01\\\",\\\"properties\\\":{\\\"car_stop\\\":1}}]}\"\r\n";
char Tx_FlagReset[BUFFE_SIZE] = "AT+HMPUB=1,\"$oc/devices/649a72522a3b1d3de71e9e81_car02/sys/properties/report\",66,\"{\\\"services\\\":[{\\\"service_id\\\":\\\"car_01\\\",\\\"properties\\\":{\\\"car_stop\\\":0}}]}\"\r\n";
uint16_t stableTx_length = 0;
/***************命令下发响应消息构造*****************/
char responseMessage[BUFFE_SIZE] = "AT+HMPUB=1,\"$oc/devices/649a72522a3b1d3de71e9e81_car02/sys/commands/response/";
uint16_t stableResponse_length_cmd = 0;
char responseProperties[BUFFE_SIZE] = "AT+HMPUB=1,\"$oc/devices/649a72522a3b1d3de71e9e81_car02/sys/properties/set/response/";
...
void USER_UART_IDLECallback(UART_HandleTypeDef *huart)
{
  if (huart->Instance == USART1)
  {
    ...
    //获取数据长度
    Rxcounter = MAX_LENGTH - __HAL_DMA_GET_COUNTER(&hdma_usart1_rx);
...
int main(void)
{
  ...
  /****连接华为云****/
  //服务地址 端口号 设备ID 设备秘钥
  uart_L610_send("AT+HMCON=0,60,\"121.36.42.100\",\"8883\",\"649a72522a3b1d3de71e9e81_car02\",\"123456789\",0\r\n");
  ...
  uart_L610_send("AT+HMPUB=1,\"$oc/devices/649a72522a3b1d3de71e9e81_car02/sys/properties/report\",87,\"{\\\"services\\\":[{\\\"service_id\\\":\\\"car_01\\\",\\\"properties\\\":{\\\"location\\\":[32.129368,118.958233]}}]}\"\r\n");
  //绿色状态灯亮起,初始化完成
  HAL_Delay(600);
